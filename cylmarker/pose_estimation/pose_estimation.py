...
from cylmarker.pose_estimation import img_segmentation, keypoints
...
def estimate_poses(cam_calib_data, config_file_data, data_pttrn, data_marker):
    ...
    for im_path in img_paths:
        ...
        # Find keypoints
        keypoints_list = keypoints.find_keypoints(mask_marker_fg, min_n_keypoints, max_ang_diff, sequence_length)
        # TODO: Estimate pose
