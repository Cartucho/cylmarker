...
from cylmarker.pose_estimation import img_segmentation, keypoints, sequences
...
def estimate_poses(cam_calib_data, config_file_data, data_pttrn, data_marker):
    ...
    for im_path in img_paths:
        ...
        # Find keypoints
        keypoints_list = keypoints.find_keypoints(im, mask_marker_fg, min_n_keypoints)
        # TODO: Find sequences
        sequences.find_sequences(keypoints_list)
        # TODO: Estimate pose
